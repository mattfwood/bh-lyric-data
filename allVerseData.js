module.exports = [
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Kevin Abstract & Joba',
        verse:
  ...
  { songTitle: 'American Boyband Theme Song', verses: [] },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Kevin Abstract & Dom McLennon',
        verse:
          "[Bridge: Kevin Abstract & Dom McLennon]\nNiggas on that word of mouth\n'til they see them boys come out\nI ain't ever robbed a nigga\nBest believe I air ya out\nSee me in your area\nY'all niggas hilarious\nI'm addicted to writing shit\nThat make niggas scared of us [x4]",
        verseType: 'Bridge',
      },
      {
        verseOwner: 'Ameer Vann',
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Kevin Abstract & bearface',
        verse:
          "[Outro: Kevin Abstract & bearface]\nI forgot my passport\nSure, all for a pretty sky\nI forgot my passport\nSure, all for a pretty sky\nI forgot my passport\nSure, all for a pretty sky\nI've got my passport\nSure, all for a pretty sky\n[?]\nTell me why\nTell me why",
        verseType: 'Outro',
      },
    ],
  },
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Dom McLennon (Merlyn Wood)',
        verse: '[Video Outro: Dom McLennon (Merlyn Wood)]\nMerlyn!',
        verseType: 'Video Outro',
      },
    ],
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Ameer Vann & Merlyn Wood',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Matt Champion, Kevin Abstract, Joba',
        verse:
  ...
  { songTitle: 'CINEMA 1', verses: [] },
  { songTitle: 'CINEMA 2', verses: [] },
  { songTitle: 'CINEMA 3', verses: [] },
  { songTitle: 'CONTACTS', verses: [] },
  {
    songTitle: 'COTTON HOLLOW',
    verses: [
      {
        verseOwner: 'Dom McLennon',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Kevin Abstract & Merlyn Wood',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'JOBA & (Kevin Abstract)',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      },
      {
        verseOwner: 'Kevin Abstract & Merlyn Wood',
        verse:
          "[Hook: Kevin Abstract & Merlyn Wood]\nKeep a gold chain on my neck\nFly as a jet, boy, better treat me with respect\nKeep a gold chain on my neck\nFly as a jet, boy, better treat me with respect\n(Keep a gold chain) Keep a gold chain on my neck\nFly as a jet, boy, (they don't want this) better treat me with respect\n(Keep a gold chain) Keep a gold chain on my neck\nFly as a jet, boy, better treat me with respect",
        verseType: 'Hook',
      },
      {
        verseOwner: 'Merlyn Wood',
        verse:
          "[Verse 3: Merlyn Wood]\nI'm frosty\nSee the femder, I'm flossing\nSee the camo, I'm dousing\nBut you don't see what it cost me\nTurmoil like the Saudid\nHand-me-downs never fit me\nParty never fit me\nPunani never fit me\nDamn, time-travelin'\nHonda-swervin', that's so Merlyn\nThat's so Merlyn\nThat's so Merlyn, that's so Merlyn\nDamn, time-travelin'\nHonda-swervin', that's so Merlyn\nThat's so Merlyn\nThat's so Merlyn, that's so Merlyn",
        verseType: 'Verse 3',
      },
    ],
  },
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Merlyn Wood & Kevin Abstract',
        verse:
  ...
  },
  {
    ...
    verses: [
      {
        verseOwner: 'Sample from BROCKHAMPTON - "BEN CARSON"',
        verse: '[Sample from BROCKHAMPTON - "BEN CARSON"]',
        verseType: 'N/A',
      },
      {
        verseOwner: 'Sample from KEVIN ABSTRACT - "LEADER"',
        verse: '[Sample from KEVIN ABSTRACT - "LEADER"]',
        verseType: 'N/A',
      },
      {
        verseOwner: 'Sample from MATT CHAMPION - "MANSION"',
        verse: '[Sample from MATT CHAMPION - "MANSION"]',
        verseType: 'N/A',
      },
      {
        verseOwner: 'Ariel Wendt',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Matt Champion & Kevin Abstract',
        verse:
  ...
  { songTitle: 'QUICK*', verses: [] },
  {
    ...
    verses: [
      ...
      },
      {
        verseOwner: 'Bearface',
        verse:
          "[Verse: Bearface]\nThank you notes kept falling out your mouth\nNever wished for you to see them, never what we were about\nOnly color in your eyes when you look me though that\nBlue\nNow you're sinking 'cus the water rising up around your collar\nIf you wish to call me over, I'll be right around the corner\nI'll be in the water with ya, I'll be sinking with\nYou\nBut you—",
        verseType: 'Verse',
      },
      {
        verseOwner: 'Bearface',
  ...
  { songTitle: 'SATURATION [Tracklist + Cover Art]', verses: [] },
  {
    songTitle: 'SCENE 2',
    verses: [
      { verseOwner: 'Translation', verse: '[Translation]', verseType: 'N/A' },
      {
        verseOwner: 'Robert Ontenient',
        verse:
    ...
    verses: [
      {
        verseOwner: 'Matt Champion',
        verse:
          "[Verse 1: Matt Champion]\nShoot 'em dead\nSpit the wish bone\nBad luck, spill the weed on the carpet\nNo more babysitter, no more homework\nNo more van ride to the mountains\nWith the GameCube taped up\nTake the auto down the block\nWith the scratches on the door\nC.D, no aux\nSlowburn (slowburn)\nSlowburn (slowburn)\nSlowburn",
        verseType: 'Verse 1',
      },
      {
        verseOwner: 'Kevin Abstract',
        verse:
          "[Verse 1: Kevin Abstract]\nWhere do I go when I die?\nWhat if I spend my whole life\nBein' a bad ass boy with a crate on the side?\nI keep my face in my lap\nWanna sit in the back when mom driving around\nWe've got church in an hour\nWhere do I go when I die?\nWhat if I spend my whole life\nBein' a bad ass boy with a crate on the side?\nI keep my face in my lap\nWanna sit in the back when mom driving around\nWe've got church in an hour",
        verseType: 'Verse 1',
      },
      {
        verseOwner: 'Merlyn Wood',
        verse:
          "[Verse 2: Merlyn Wood]\nOn site, when I pull up to the light\nMy bike sound like Skype (woo-woo)\nI don't write, I'm just pulling out the sky\nI was there for attendance then I died\nOn site, when I pull up to the light\nMy bike sound like Skype (woo-woo)\nI don't write, I'm just pulling out the sky\nI was there for attendance then I died",
        verseType: 'Verse 2',
      },
      {
        verseOwner: 'Joba',
        verse:
          '[Outro: Joba]\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI just wanna know where the love at\nWhere the, where the love at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at\nI know where love is at, I know where love is at',
        verseType: 'Outro',
      },
    ],
  },
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Ameer Vann & Matt Champion',
        verse:
  ...
  },
  {
    ...
    verses: [
      ...
      {
        verseOwner: 'Bear//Face & Joba',
        verse:
          "[Outro: Bear//Face & Joba]\nRunnin' outta time again\nRunnin' outta time again\nRunnin' outta time again\nMmmm\nAy-yeahhh\nAy-yeahhh\nOooh, oooh, oo-ooh, oooh",
        verseType: 'Outro',
      },
    ],
  },
  {
    ...
    verses: [
      {
        verseOwner: 'Ameer Vann & Robert Ontenient',
        verse:
      ...
      {
        verseOwner: 'Kevin Abstract & Matt Champion',
        verse:
    ...
    verses: [
      {
        verseOwner: 'Kevin Abstract & Bearface',
        verse:
          "[Chorus: Kevin Abstract & Bearface]\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nI said 'em back to you\nI said 'em back to you",
        verseType: 'Chorus',
      },
      {
        verseOwner: 'Bearface & Kevin Abstract',
        verse:
      ...
      },
      {
        verseOwner: 'Kevin Abstract & Bearface',
        verse:
          "[Extended Chorus: Kevin Abstract & Bearface]\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nI said 'em back to you\nI said 'em back to you\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nThis is my confession tape\nAll the words I had to say, I said 'em back to you\nI said 'em back to you\nI said 'em back to you",
        verseType: 'Extended Chorus',
      },
    ],
  },
  {
    ...
    verses: [
      {
        verseOwner: 'Kevin Abstract',
        verse:
          "[Kevin Abstract]\nYou ain't shit to me (ain't shit to me)\nI'll break a nigga head before i leave (Before I)\nI take a sip and proceed to dream\nI just want another mother fucking victory lap",
        verseType: 'N/A',
      },
      {
        verseOwner: 'Merlyn Wood',
        verse:
          "[Merlyn Wood]\nComing from a hard place, i'm a resident\nWhat did you rape outta my life, (?)\nRepresenting shit, i instagram my only shit\nTalking recordless (?)",
        verseType: 'N/A',
      },
    ],
  },
    ...
    verses: [
      {
        verseOwner: 'Kevin Abstract',
        verse:
          "[Chorus: Kevin Abstract]\nYou ain't shit to me\nI'll break a nigga head before I leave\nI take a sip and proceed to drink\nI just want another motherfuckin' victory lap\nYou ain't shit to me\nI'll break a nigga head before I leave\nI take a sip and proceed to drink\nI just want another motherfuckin' victory lap\nYou ain't shit to me\nI'll break a nigga head before I leave\nI take a sip and proceed to drink\nI just want another motherfuckin' victory lap",
        verseType: 'Chorus',
      },
      {
        verseOwner: 'Merlyn Wood',
        verse:
          "[Verse: Merlyn Wood]\nComing from a hard place, I'm a resident\nBut they do right, [?] my life with embellishment\nRepresenting shit my [?] my homies say\nTalking reckless, my brain [?] better shit",
        verseType: 'Verse',
      },
    ],
  },
  { songTitle: 'TRACK 2', verses: [] },
  {
    songTitle: 'TRACK 20',
    verses: [
      {
  ...
  },
  {
    ...
    verses: [
      ...
      },
      {
        verseOwner: 'Ameer Vann',
        verse:
          "[Verse 4: Ameer Vann]\nI always pay in cash, so I ain't got no credit\nI'ma need a co-sign if you're tryna get it\nMove about the house, close my bank account\nThey couldn't fill my check, I need to buy a jet\nI ain't been the same since Viceland payed\nSee me on the screen, my million dollar face\nMy momma told me I was gonna be a star, yeah\nI payed the debt and then I went a bought a car, yeah",
        verseType: 'Verse 4',
      },
    ],
  },
